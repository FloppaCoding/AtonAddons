...
object ClickGui: Module(
    ...
    val guiName: StringSetting = StringSetting("Name", "Aton Addons", description = "Name that will be rendered in the gui.")
    ...
    val customPrefix = StringSetting("Custom Prefix", "§0§l[§4§lAton Addons§0§l]§r", 40, description = "You can set a custom chat prefix that will be used when Custom is selected in the Prefix Style dropdown.")
