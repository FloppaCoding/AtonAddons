package atonaddons.ui.clickgui

import atonaddons.AtonAddons
import atonaddons.AtonAddons.Companion.moduleConfig
...
import atonaddons.ui.clickgui.elements.menu.ElementColor
import atonaddons.ui.clickgui.elements.menu.ElementSlider
...
class ClickGUI : GuiScreen() {
    ...
    private val logo = ResourceLocation(AtonAddons.RESOURCE_DOMAIN, "gui/Icon.png")
...
//        val scaledMouseY = (mouseY / scale).toInt()
        ...
        logo.let {
            ...
            val titleWidth = FontUtil.getStringWidth(ClickGui.guiName.text)

            GlStateManager.color(255f, 255f, 255f, 255f)
            AtonAddons.mc.textureManager.bindTexture(it)
            ...
            FontUtil.drawString(
                ClickGui.guiName.text,
                -titleWidth.toDouble() - 10.0 - logoHeight,
                -FontUtil.fontHeight.toDouble() / 2.0 - 5.0 - logoHeight / 2.0,
                titleColor
            )
            GL11.glPopMatrix()
        }
...
//        val scaledMouseY = (mouseY / scale).toInt()
        ...
        val i1: Int = scaledresolution.scaledWidth
        val j1: Int = scaledresolution.scaledHeight
        val k1: Int = Mouse.getX() * i1 / AtonAddons.mc.displayWidth
        val l1: Int = j1 - Mouse.getY() * j1 / AtonAddons.mc.displayHeight - 1
        val scaledMouseX = (k1 / scale).toInt()
        val scaledMouseY = (l1 / scale).toInt()
