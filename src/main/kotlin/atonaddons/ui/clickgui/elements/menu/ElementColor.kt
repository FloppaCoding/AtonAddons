...
class ElementColor(iparent: ModuleButton, iset: Setting) : Element() {
    ...
    private val hueScale = ResourceLocation(AtonAddons.RESOURCE_DOMAIN, "gui/HueScale.png")
    ...
    override fun keyTyped(typedChar: Char, keyCode: Int): Boolean {
        if (!comboextended) return false
        val scaledresolution = ScaledResolution(AtonAddons.mc)
        ...
        val scale = 2.0 / AtonAddons.mc.gameSettings.guiScale
