...
loom {
    launchConfigs {
        getByName("client") {
            ...
            arg("--mixin", "mixins.atonaddons.json")
        }
    }
    forge {
        pack200Provider.set(Pack200Adapter())
        mixinConfig("mixins.atonaddons.json")
    }
    mixin {
        defaultRefmapName.set("mixins.atonaddons.refmap.json")
    }
}
...
tasks {
    ...
    named<Jar>("jar") {
        manifest.attributes(
            ...
            "FMLCorePlugin" to "atonaddons.forge.FMLLoadingPlugin",
            "ForceLoadAsMod" to true,
            "MixinConfigs" to "mixins.atonaddons.json",
            "ModSide" to "CLIENT",
    ...
    named<RemapJarTask>("remapJar") {
        archiveBaseName.set("AtonAddons")
